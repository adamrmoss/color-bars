...
Inherits DesktopApplication
	...
	#tag Constant, Name = FileQuitTitle, Type = String, Dynamic = False, Default = \"&Quit", Scope = Public
		#Tag Instance, Platform = Windows, Language = Default, Definition  = \"E&xit"
	#tag EndConstant

	#tag Constant, Name = FileTitle, Type = String, Dynamic = False, Default = \"&File", Scope = Public
	#tag EndConstant
